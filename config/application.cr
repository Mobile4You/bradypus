...
Amber::Server.configure do |settings|
  ...
  #
  # settings.name = "Bradypus web application."
  #
  #
  ...
  #
  # settings.secret_key_base= IQ3ok1CLtoLXZ0480Pet1asZiLigsFeJIzuxRuACS0U
  #
  #
  ...
  #
  # settings.logger = Amber::Environment::Logger.new(File.open("bradypus.log", "w"))
  #
  #
end
